...
enum Endpoint {
    ...
    case createAccount(path: String = "/auth/create-account", userRequest: RegistrationViewController)
    case logIn(path: String = "/auth/sign-in", userRequest: LoginViewController)
